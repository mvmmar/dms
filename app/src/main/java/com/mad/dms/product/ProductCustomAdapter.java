...
public class ProductCustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView productName = cusView.findViewById(R.id.proName);
        TextView productDes = cusView.findViewById(R.id.proDescription);
        TextView productPrice = cusView.findViewById(R.id.proPrice);
        TextView productQuantity = cusView.findViewById(R.id.proQuantity);
        ImageView productIcon = cusView.findViewById(R.id.productIcon);
